 <template>
    <VContainer class="container"  fluid color="surface"  >
        <VRow class="pd-1" max-width="1200px" >
            <VCol class="col col1">
                <VSheet class="pd-2" height="250">
                    <p>Enter date range for Analysis</p>
                    <div></div>
                    <v-text-field class="mr-5" v-model="start" label="Start Date" type="date" density="compact" variant="solo-inverted" style="max-width: 300px" flat></v-text-field>
                    <v-text-field v-model="end" label="End date" type="Date" density="compact" variant="solo-inverted" style="max-width: 300px" lat></v-text-field>
                    <VSpacer></VSpacer>
            ...
            <VCol class="col col2" cols="3" align="center">
        ...
        <VRow class="row row2" max-width="1200px">
            ...
            <VCol class="col col2" cols="12">
                <figure class="highcharts-figure">
                    <div id="container 0" ></div>
                </figure>
            </VCol>
        </VRow>
        <VRow class="row row3" max-width="1200px">
